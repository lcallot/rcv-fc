...
mod.smpl <- matrix(rbind(
			 ...
			 # A few VAR
			 c('var',1,'Lasso','lasso','dj.cens.lcov.W',263,'none'),
			 c('var',1,'Lasso','none','dj.cens.lcov.W',263,'none'),
			 #c('var',2,'Lasso','lasso','dj.cens.lcov.W',263,'none'),
			 # A few censored VAR
			 # c('var',2,'Lasso','none','dj.cens.lcov.W',263,'none'),
			 c('var',5,'Lasso','none','dj.cens.lcov.W',263,'none'),
			 c('var',5,'Lasso','lasso','dj.cens.lcov.W',263,'none')
			# AR
			 #c('var',1,'Lasso','none','dj.cens.lcov.W',263,'ar'),
			 #c('var',2,'Lasso','none','dj.cens.lcov.W',263,'ar'),
			 #c('var',5,'Lasso','none','dj.cens.lcov.W',263,'ar')
			 ),ncol=7,
...
fc.roll(mod.smpl,hmax=1,diag.ind=diag.ind)

@


<<mk-stattab-W,dependson='roll-forecast-W',cache=TRUE,eval=FALSE>>=
hsel <- c(1)
...
<<prt-stattab-W,results='asis',cache=TRUE,dependson='mk-stattab-W',eval=FALSE>>=
