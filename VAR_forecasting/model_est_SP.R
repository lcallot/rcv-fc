...
models <- matrix(rbind(
  ...
  c('var',20,'Lasso','none','fac.cens.lcov',1000,'none'),
  c('var',1,'Lasso','none','fac.cens.lcov.W',263,'none'),
  c('var',5,'Lasso','none','fac.cens.lcov.W',263,'none'),
  c('var',1,'Lasso','none','fac.cens.lcov.M',60,'none'),
  c('var',5,'Lasso','none','fac.cens.lcov.M',60,'none')
),ncol=7,
